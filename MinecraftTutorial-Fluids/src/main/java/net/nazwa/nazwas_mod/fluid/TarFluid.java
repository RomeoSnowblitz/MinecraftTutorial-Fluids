...
public class TarFluid extends FlowableFluid {
    public TarFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.TAR_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.TAR_FLUID_STILL;
    }

    public Item getBucketItem() {
        return ModItems.TAR_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) ModBlocks.TAR_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.TAR_FLUID_STILL || fluid == ModFluids.TAR_FLUID_FLOWING;
    }
